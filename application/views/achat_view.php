                                    ...
                                    <table class="table" id="table" data-toggle="table"  data-search="true"    data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->nomCli ; ?> <?php echo $row->prenomCli ; ?></td>
                                                <td><?php echo $row->idCli ; ?></td>
                                                <td><?php echo $row->numfact ; ?></td>
                                                <td>
                                                     
                                                        <a href="<?php echo base_url('achat_controller/detail'); ?>/<?php echo $row->idCli ; ?>/<?php echo $row->numfact ; ?>"><button  title="details" class="pd-setting-ed editProduit"  > Details</button> </a>
                                                </td>
                                                <td>
                                                    
                                                        <a href="<?php echo base_url('achat_controller/imprimer'); ?>/<?php echo $row->idCli ; ?>/<?php echo $row->numfact ; ?>"  title="impression" class="pd-setting-ed " >
                                                         <button  title="impression" class="pd-setting-ed editProduit" > <i class="fa fa-print" aria-hidden="true"></i> Imprimer </button>
                                                        </a></td>
