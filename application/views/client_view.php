    ...
    <div class="all-content-wrapper">
                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                        <a class="btn btn-danger" href="" data-toggle="modal" data-target="#DangerModalAdd">Nouveau client</a>
                                    </div>
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->adrsCli ; ?></td>
                                                <td><?php echo $row->telCli ; ?></td>
                                                <td>
                                                    <button  title="Edit" class="pd-setting-ed editClient" data-toggle="modal" data-target="#DangerModalEdit">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button  title="supprimer" class="pd-setting-ed deleteClient" data-toggle="modal" data-target="#DangerModalalert">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header header-color-modal bg-color-4">
                                        <h4 class="modal-title">Formulaire d'ajout Client</h4>
                                        <div class="modal-close-area modal-close-df">
                                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="<?php echo base_url('client_controller/inserer') ; ?>">
                                            ...
                                            <div class="input-group mg-b-pro-edt">
                                                ...
                                                <input type="text" class="form-control" name="adrsCli" placeholder="Adresse" required>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="telCli" placeholder="Telephone " required>
                                            </div>
                                   </div>
        ...
        <div id="DangerModalEdit" class="modal modal-adminpro-general FullColor-popup-DangerModal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header header-color-modal bg-color-4">
                                        <h4 class="modal-title" id="modifCliTitre"></h4>
                                        <div class="modal-close-area modal-close-df">
                                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="<?php echo base_url('client_controller/editer') ; ?>">
                                            <input type="hidden" class="form-control" name="idCliEdit" id="idCliEdit" placeholder="Prenom " required>
                                            
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="nomCliEdit" id="nomCliEdit"  placeholder="Nom " required>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="prenomCliEdit" id="prenomCliEdit"  placeholder="Prenom " required>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="adrsCliEdit" id="adrsCliEdit" placeholder="Adresse" required>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="telCliEdit" id="telCliEdit" placeholder="Telephone " required>
                                            </div>
                                   </div>
                                    <div class="modal-footer">
                                        <button data-dismiss="modal" class="btn btn-default" href="#">Annuler</button>
                        ...
                        <div id="DangerModalalert" class="modal modal-adminpro-general FullColor-popup-DangerModal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <form method="post" action="<?php echo base_url('client_controller/supprimer') ; ?>">
                                        <span class="adminpro-icon adminpro-danger-error modal-check-pro information-icon-pro"></span>
                                        <h2>Suppression!</h2>
                                        <input type="hidden" id="idCliDelete" name="idCliDelete" required/>
          ...
          $(document).ready(function(){
              $(".editClient").on('click', function(){
               ...
               var data=$tr.children("td").map(function(){
                ...
                console.log(data);
                $("#idCliEdit").val(data[0]);
                $("#nomCliEdit").val(data[1]);
                $("#prenomCliEdit").val(data[2]);
                $("#adrsCliEdit").val(data[3]);
                 $("#telCliEdit").val(data[4]);
              
                document.getElementById('modifCliTitre').innerHTML=" Edition du client numero: "+data[0]+" ";
          ...
          $(document).ready(function(){
              $(".deleteClient").on('click', function(){
               ...
               var data=$tr.children("td").map(function(){
                ...
                console.log(data);
                $("#idCliDelete").val(data[0]);
                document.getElementById('deleteConfirme').innerHTML=" Voulez-vous vraiment supprimer le client numero "+data[0]+" ";
